...
while True:
    ...
    if inputstr and inputstr.split()[0].lower() in ['a', 'add', 'append']:

        with open(dictPath, 'a', encoding='utf') as file:
            file.write('\n' + inputstr.split()[1])
        print()
        print('Слово добавлено в локальный словарь')
    ...
    if inputstr and inputstr.split()[0].lower() in ['s', 'sim']:
        ...
        print()
        print('Похожие слова (первые 12 шт.):')
